                ...
                <div class="container">
                    <div class="addProductWrapper">
                        ...
                        <div class="basic-form">
                            <form id="add-user-form">
                             ...
                             <div class="form-group">
                                    <input class="form-control mb-2" type="text" placeholder="Enter Crust Name" name="name">
                                    <label>Price</label>
                                    <input class="form-control mb-2" id="price" type="number" placeholder="Enter Product Price" name="price" required>
                                    <label>Crust Image</label>
                        ...
                        <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary btn-lg m-3"> Save Cheese </button>
                                </div>
...
$(form).on('submit', function(event){
    ...
    $.ajax({
        url: "http://esan.megaenterprisegroup.com/pizzaAdmin/api/add-crust",
        method: 'POST',
        ...
        { 
            if(response.status== "success"){
                showSuccessAlert();
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/view-crust";
            }
            else{
                showError();
            }
