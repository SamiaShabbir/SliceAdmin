                    ...
                    <div class="addProductWrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                                <h4 class="text-center breadColor">Edit crust</h4>
                                <br />
    ...
    <script>
        $(document).ready(function() {
            ...
            function veiwProduct() {
                ...
                // alert(edit_id)
                $.ajax({
                    url: `http://esan.megaenterprisegroup.com/pizzaAdmin/api/get-crust-by-id/${edit_id}`,
                    type: "GET",
            ...
            $("#add-user-form").on('submit', function(event) {
                ...
                $.ajax({
                    url: `http://esan.megaenterprisegroup.com/pizzaAdmin/api/edit-crust/${edit_id}`,
                    method: 'POST',
                    ...
                    success: function(response) {
                        if (response.status == "success") {
                            ...
                            window.location.href =
                                "http://esan.megaenterprisegroup.com/pizzaAdmin/view-crust";
                        } else {
                            showError()
                        }
                    },
