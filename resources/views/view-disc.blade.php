            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center breadColor">Disc</h4>
    ...
    ***********************************-->
        ...
        <script>
            ...
            function viewCategories() {
                ...
                $.ajax({
                    url: "http://esan.megaenterprisegroup.com/pizzaAdmin/api/get-disc",
                    type: "GET",
                    success: function(data) {
                        var count = 1;
                        if (data.status == "success") {
                            $.each(data.data, function(index, obj) {
                                var status = obj.status == null ? 'ACTIVE' : 'INACTIVE';
                                $list.append('<tr>' +
                                    '<td class="text-capitalize">' + obj.disc_no + '</td>' +
                                    '<td class="text-capitalize"><span class="badge badge-primary">' +
                                    status + '</span></td>' +
                                    '<td>' +
                                    '<span>' +
                                    '<a id="' + obj.id +
            ...
            function deleteCategory(id) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `http://esan.megaenterprisegroup.com/pizzaAdmin/api/remove-disc/${delete_id}`,
                            type: "get",
            ...
            function editCategory(id) {
                ...
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/edit-disc";
