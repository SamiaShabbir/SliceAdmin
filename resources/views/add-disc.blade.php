                        ...
                        <div class="basic-form">
                            <form id="add-user-form">
                             ...
                             <div class="form-group">
                                    <input class="form-control mb-2" type="number" placeholder="Enter Disc Number" name="disc_no">
                        <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary btn-lg m-3"> Save Disc </button>
                                </div>
    ...
    $.ajax({
        ...
        { 
            if(response.status== "success"){
                showSuccessAlert();
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/view-disc";
            }
            else{
                showError();
            }
