...
<div class="table-responsive">
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        ...
                                        <tr id="product_id">
                                                ...
                                                <td class="d-flex justify-content-center align-items-center"><img class="w-50 rounded" src=${product.image}></td>
                ...
                if ( data.status == "success")
                {
                    $.each(data.data.pizza, function(index,obj) 
                    {
                        $list.append('<tr>'+
                                        ...
                                        '<td class="ImgContainer "><img class="w-75" src="http://esan.megaenterprisegroup.com/pizzaAdmin/public/images/'+obj.image+'"></td>'+
                                        '<td>'+
                                            '<span>'+
                                                '<a id="'+obj.id+'" onclick="deletePizza(this.id)" data-toggle="tooltip" data-placement="top" title="Delete"><i class="bi bi-trash text-danger"></i></a>'+
                                            '</span>'+
                                        '</td>'+
                                    '</tr>');
                        count++;
                ...
                if ( data.status == "success")
                {
                    $.each(data.data.Drink, function(index,obj) 
                    {
                        $list.append('<tr>'+
                                        ...
                                        '<td>'+
                                            '<span>'+
                                            '<a id="'+obj.id+'" onclick="editProduct(this.id)" class="mr-4 w-100" data-toggle="tooltip" data-placement="top" title="Edit"><i class="bi bi-pen text-warning fs-1"></i> </a>'+
                                                '<a id="'+obj.id+'" onclick="deleteProduct(this.id)" data-toggle="tooltip" data-placement="top" title="Delete"><i class="bi bi-trash text-danger"></i></a>'+
                                            '</span>'+
                                        '</td>'+
                                    '</tr>');
                        count++;
