            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center breadColor">Pizza Category</h4>
    ...
    ***********************************-->
        ...
        <script>
            ...
            function viewCategories() {
                ...
                $.ajax({
                    url: "http://esan.megaenterprisegroup.com/pizzaAdmin/api/get-sub-category",
                    type: "GET",
            ...
            function deleteCategory(id) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `http://esan.megaenterprisegroup.com/pizzaAdmin/api/delete-sub-category/${delete_id}`,
                            type: "get",
            ...
            function editCategory(id) {
                ...
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/edit-pizza-category";
