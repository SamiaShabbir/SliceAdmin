                        ...
                        <div class="basic-form">
                            <form id="add-user-form">
                             ...
                             <div class="form-group">
                                    <input class="form-control mb-2" type="text" placeholder="Enter Text" name="sub_cat_name" required>
                            
                                    <input class="form-control mb-2" type="number" placeholder="Enter ID" name="category_id" required>
    ...
    $.ajax({
        ...
        { 
            if(response.status== "success"){
                showSuccessAlert();
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/pizza-category";
            }
            else{
                showError();
            }
