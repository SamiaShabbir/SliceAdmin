...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('/assets/plugins/bootstrap-touchspin/css/jquery.bootstrap-touchspin.min.css') }}">
                    ...
                    <div class="addProductWrapper">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-10 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                                <h4 class="text-center breadColor">Add Product</h4>
                                    ...
                                    <form id="add-user-form">
                                        ...
                                        <div id="edit-product">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-2 d-none" id="name" type="text"
                                                    placeholder="Enter Product Name" value="Pizza" name="cat_name">
                                                ...
                                                <div class="Wrapper">
                                                    <div class="size line row">
                                                        ...
                                                        <div class="col-4 text-start fw-bold fs-3 text-dark"><b>18"</b>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div class="size line row m-2">
                                                        <div class="col-4">
                                                            <h5 class="fs-4 m-2 text-capitalize"> Price ($) for Display
                                                            </h5>
                                                        </div>
                                                        <div class="col-4 text-start fw-bold fs-3 text-dark">
                                                            <div class="form-group">
                                                                <input id="result1" type="number" value=""
                                                                    name="price1" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-4 text-start fw-bold fs-3 text-dark">
                                                            <div class="form-group">
                                                                <input id="result2" type="number" value=""
                                                                    name="price2" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="size line row m-2">
                                                        <div class="col-4">
                                                            <h5 class="fs-4 m-2 text-capitalize"> Price ($) for Dough
                                                            </h5>
                                                        </div>
                                                        <div class="col-4 text-start fw-bold fs-3 text-dark">
                                                            <div class="form-group">
                                                                <input id="doughValue12" type="number"
                                                                    value="" name="dough_price1"
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-4 text-start fw-bold fs-3 text-dark">
                                                            <div class="form-group">
                                                                <input id="doughValue18" type="number"
                                                                    value="" name="dough_price2"
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row m-2">
                                                        <div class="col-6">
                                                            <h5 class="text-dark fs-3 text-capitalize">Cheese
                                                                <small>(Choosed item will be auto select on App)</small>
                                                            </h5>
                                                        </div>
                                                        <div class="col-6">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="radio">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="cheez_{{ $cheez->id }}">{{ $cheez->cheese }}
                                                                        <br />
                                                                        <small>(
                                                                            12" Cheese Price:
                                                                            {{ '$' . $cheez->cheese_price }} and
                                                                            18" Cheese Price:
                                                                            {{ '$' . $cheez->cheese_price_18 }}
                                                                            )</small>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row m-2">
                                                        <div class="col-6">
                                                            <h5 class="text-dark fs-3 text-capitalize">Sauce
                                                                <small>(Choosed item will be auto select on App)</small>
                                                            </h5>
                                                        </div>
                                                        <div class="col-6">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="radio">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        value="{{ $cheez->sauce }}">
                                                                    <label class="form-check-label"
                                                                        for="sauce_{{ $cheez->id }}">{{ $cheez->sauce }}
                                                                        <br />
                                                                        <small>(
                                                                            12" Sauce Price:
                                                                            {{ '$' . $cheez->sauce_price }} and
                                                                            18" Sauce Price:
                                                                            {{ '$' . $cheez->sauce_price_18 }}
                                                                            )</small>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row m-2">
                                                        <div class="col-4">
                                                            <h5 class="text-dark m-1 fs-3 text-capitalize">Toppings
                                                            </h5>
                                                        </div>
                                                        <div class="col-4">
                                                            <!--<h5 class="text-dark m-1 fs-3 text-capitalize">Price for calculation </h5>-->
                                                            ...
                                                            <div class="col-5">
                                                                <div class="form-check m-2">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        ...
                                                                        value="{{ $topping->regular_toppings }}">
                                                                    <label class="form-check-label"
                                                                        for="topping_{{ $topping->id }}">{{ $topping->regular_toppings }}
                                                                        <br />
                                                                        <small>(Regular:
                                                                            {{ '$' . $topping->regular_topping_price }},
