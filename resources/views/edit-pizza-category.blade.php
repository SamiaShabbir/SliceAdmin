    ...
    <script>
        $(document).ready(function() {
            ...
            function veiwProduct() {
                ...
                $.ajax({
                    url: `http://esan.megaenterprisegroup.com/pizzaAdmin/api/edit-sub-category/${edit_id}`,
                    type: "GET",
                        ...
                        if (data.status == "success") {
                            $.each(data.data, function(index, obj) {
                                ...
                                $list.append(
                                    ...
                                    obj.sub_cat_name +
                                    '" type="text"  name="sub_cat_name"required>' +
                                    ' <input class="form-control mb-2" id="name" value="' +
                                    obj.category_id +
                                    '" type="number"  name="category_id" required>' +
                                    '</div>');
                            });
                        } else {
                            console.log("error")
