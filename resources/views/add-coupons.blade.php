                        ...
                        <div class="basic-form">
                            <form id="add-user-form">
                             ...
                             <div class="form-group">
                                    <input class="form-control mb-2" type="number" placeholder="Enter Text" name="coupon_number" required>
                                    <div class="form-group">
                                        <label>Choose Type of Discount</label> <br/>
                                                        <label for="mailclient14" class="mailclinet mailclinet-another">
                                                            <input type="radio" default name="type" id="mailclient14" value="discount">
                                                            <span class="mail-icon">
                                                                <i class="fa fa-question-circle-o" aria-hidden="true"></i>
                                                            </span>
                                                            <span class="mail-text">Percent</span>
                                                        </label>
                                                        <label for="mailclient14" class="mailclinet mailclinet-another">
                                    ...
                                    <input class="form-control mb-2" type="text" placeholder="Enter Discount" name="discount" required>
                                    <input class="form-control mb-2" type="date" placeholder="Add expiry Date" name="expiry_date" required>
                        <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary btn-lg m-3"> Save Coupons </button>
                                </div>
...
$(form).on('submit', function(event){
    ...
    $.ajax({
        url: "http://esan.megaenterprisegroup.com/pizzaAdmin/api/add-coupons",
        method: 'POST',
        ...
        { 
            if(response.status== "success"){
                showSuccessAlert();
                window.location.href = "http://esan.megaenterprisegroup.com/pizzaAdmin/view-coupons";
            }
            else{
                showError();
            }
