                    ...
                    <div class="addProductWrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                                <h4 class="text-center breadColor">Add Coupons</h4>

                                <div class="basic-form">
                                    <form id="add-user-form">
                                        @csrf
                                        <div class="form-group">
                                            <input class="form-control mb-2" type="number" placeholder="Enter Text"
                                                name="coupon_number" required>
                                            <div class="form-group">
                                                <label>Choose Type of Discount</label> <br />
                                                <label for="mailclient14" class="mailclinet mailclinet-another">
                                                    <input type="radio" default name="type" id="mailclient14"
                                                        value="discount">
                                                ...
                                                <label for="mailclient14" class="mailclinet mailclinet-another">
                                                    <input type="radio" name="type" id="mailclient14"
                                                        value="amount">
                                                    <span class="mail-icon">
                                                        <i class="fa fa-question-circle-o" aria-hidden="true"></i>
                                                    </span>
                                            ...
                                            <input class="form-control mb-2" type="text" placeholder="Enter Discount"
                                                name="discount" required>
                                            <input class="form-control mb-2" type="date"
                                                placeholder="Add expiry Date" name="expiry_date" required>
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-danger btn-lg m-3"> Save Coupons
                                                </button>
                                            </div>
