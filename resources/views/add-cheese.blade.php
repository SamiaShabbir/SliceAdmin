                    ...
                    <div class="addProductWrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                                <h4 class="text-center breadColor">Add Cheese</h4>
                                <div class="basic-form">
                                    <form id="add-user-form">
                                        @csrf
                                        <div class="form-group">
                                            <input class="form-control mb-2" type="text"
                                                placeholder="Enter Cheese Name" name="name">
                                            <label>Price</label>
                                            <input class="form-control mb-2" id="price" type="number"
                                                placeholder="Enter Price" name="cheese_price" required>
                                            <label>Cheese Image</label>
                                            <div
        ...
        <script>
            $(document).ready(function() {
                ...
                $(form).on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "http://esan.megaenterprisegroup.com/pizzaAdmin/api/add-cheese",
                        method: 'POST',
