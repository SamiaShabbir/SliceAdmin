...
class AdminProduct extends Controller
{
    public function getCategoryForPizza(Request $request)
    {
        ...
        return view('add-pizza', compact('get_sub_category_list'));
    }
        ...
        if ($validator->passes()) {
            ...
            $add_s_pizza = DB::table('products')->insert(
                [
                    ...
                    'less_cheese_price_12' => $request->less_cheese_price_12,
                    'less_cheese_price_18' => $request->less_cheese_price_18,
                    'no_cheese_price_18' => $request->no_cheese_price_18,
                    'black_pepper_price_12' => $request->black_pepper_price_12,
                    'dough_price1' => $request->dough_price1,
                    'dough_price2' => $request->dough_price2,
